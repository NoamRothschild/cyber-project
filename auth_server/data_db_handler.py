...
def create_table():
    ...
    with get_db_connection() as conn:
        ...
        cursor.execute("""
            ...
            ammo1 INTEGER NOT NULL DEFAULT 0,
            ammo2 INTEGER NOT NULL DEFAULT 0,
            ammo3 INTEGER NOT NULL DEFAULT 0,
            ammo4 INTEGER NOT NULL DEFAULT 0,
            ammo5 INTEGER NOT NULL DEFAULT 0,
            ...
            potion1 INTEGER NOT NULL DEFAULT 0,
